...
public final class ContactsStub implements ContactsRepository {
    ...
    public void getListContacts(IContacts.OnResponseCallback callback) {
        ...
        new android.os.Handler().postDelayed(() -> {
            ...
            listContacts.add(new Contacts(R.drawable.ic_person, "Tom Hankler", "25.02.1987", "+38 099 1234567", "bob@gmail.com", "chukpok issoe"));
            listContacts.add(new Contacts(R.drawable.ic_person, "Diana Hankler", "25.02.1987", "+38 099 1234567", "bob@gmail.com", "chukpok issoe"));
            listContacts.add(new Contacts(R.drawable.ic_person, "Viola Hankler", "25.02.1987", "+38 099 1234567", "bob@gmail.com", "chukpok issoe"));
